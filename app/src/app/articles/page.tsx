...
export const metadata: Metadata = {
  title: "Articles & Guides | FormBlends",
  description:
...
export default function ArticlesIndex() {
  ...
  const collectionSchema = {
    ...
    description: "Evidence-based articles on GLP-1 weight loss, peptide therapy, and health optimization.",
    url: "https://formblends.com/articles",
